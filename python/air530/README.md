...
just like the ESP32 sketch; the app shows a "waiting for satellite fix"
screen rather than an error.

It is the Python/SoC counterpart of the ESP32 sketch in
`../../esp32/esp32_air530/` and supports the same two transports (Wi-Fi
and BLE).
...
Type=simple
User=pi
WorkingDirectory=/home/pi/sensor-air530
ExecStart=/home/pi/sensor-air530/venv/bin/python3 sensor_node.py
Restart=on-failure
RestartSec=5
