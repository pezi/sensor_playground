...
`../../esp32/esp32_sht41/` and supports the same two transports (Wi-Fi
and BLE).
...
Type=simple
User=pi
WorkingDirectory=/home/pi/sensor-sht41
ExecStart=/home/pi/sensor-sht41/venv/bin/python3 sensor_node.py
Restart=on-failure
RestartSec=5
