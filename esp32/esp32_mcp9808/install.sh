#!/usr/bin/env bash
# Compile and upload the esp32_mcp9808 sketch to an ESP32 dev board.
#
...
arduino-cli lib install "ArduinoJson" "Adafruit MCP9808 Library"
...
echo "Upload finished (esp32_mcp9808, $TRANSPORT)."
