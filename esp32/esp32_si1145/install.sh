#!/usr/bin/env bash
# Compile and upload the esp32_si1145 sketch to an ESP32 dev board.
#
...
arduino-cli lib install "ArduinoJson" "Grove - Sunlight Sensor"
...
echo "Upload finished (esp32_si1145, $TRANSPORT)."
