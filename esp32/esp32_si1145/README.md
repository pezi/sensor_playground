# ESP32 SI1145 Sunlight Sensor Node for Sensor Tester
...
(SI1145: visible light, infrared, UV index) via I2C.

> The SI1145 reports **visible** and **infrared** light as raw sensor counts
> (the chip is not lux-calibrated) and computes a dimensionless **UV index**
> from its photodiodes — it has no dedicated UV photodiode.
...
> The SI1145 uses fixed I2C address `0x60`.
...
```json
{"sensor":"SI1145","host":"ESP32","visible":262,"ir":253,"uv":0.3}
```
