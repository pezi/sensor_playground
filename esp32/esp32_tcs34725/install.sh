#!/usr/bin/env bash
# Compile and upload the esp32_tcs34725 sketch to an ESP32 dev board.
#
...
arduino-cli lib install "ArduinoJson" "Adafruit TCS34725"
...
echo "Upload finished (esp32_tcs34725, $TRANSPORT)."
