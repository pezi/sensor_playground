#!/usr/bin/env bash
# Compile and upload the esp32_mpu6050 sketch to an ESP32 dev board.
#
...
arduino-cli lib install "ArduinoJson" "Adafruit MPU6050" "WebSockets"
...
echo "Upload finished (esp32_mpu6050, $TRANSPORT)."
