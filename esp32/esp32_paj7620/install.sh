#!/usr/bin/env bash
# Compile and upload the esp32_paj7620 sketch to an ESP32 dev board.
#
...
arduino-cli lib install "ArduinoJson" "Gesture PAJ7620" "WebSockets"
...
echo "Upload finished (esp32_paj7620, $TRANSPORT)."
