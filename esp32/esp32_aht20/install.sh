#!/usr/bin/env bash
# Compile and upload the esp32_aht20 sketch to an ESP32 dev board.
#
...
arduino-cli lib install "ArduinoJson" "Adafruit AHTX0"
...
echo "Upload finished (esp32_aht20, $TRANSPORT)."
