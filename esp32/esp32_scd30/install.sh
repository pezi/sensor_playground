#!/usr/bin/env bash
# Compile and upload the esp32_scd30 sketch to an ESP32 dev board.
#
...
arduino-cli lib install "ArduinoJson" "SparkFun SCD30 Arduino Library"
...
echo "Upload finished (esp32_scd30, $TRANSPORT)."
