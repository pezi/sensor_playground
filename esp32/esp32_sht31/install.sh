#!/usr/bin/env bash
# Compile and upload the esp32_sht31 sketch to an ESP32 dev board.
#
...
arduino-cli lib install "ArduinoJson" "Adafruit SHT31 Library"
...
echo "Upload finished (esp32_sht31, $TRANSPORT)."
