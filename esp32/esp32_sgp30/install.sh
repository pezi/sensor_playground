#!/usr/bin/env bash
# Compile and upload the esp32_sgp30 sketch to an ESP32 dev board.
#
...
arduino-cli lib install "ArduinoJson" "Adafruit SGP30 Sensor"
...
echo "Upload finished (esp32_sgp30, $TRANSPORT)."
