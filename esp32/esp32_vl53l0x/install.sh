#!/usr/bin/env bash
# Compile and upload the esp32_vl53l0x sketch to an ESP32 dev board.
#
...
arduino-cli lib install "ArduinoJson" "Adafruit_VL53L0X" "WebSockets"
...
echo "Upload finished (esp32_vl53l0x, $TRANSPORT)."
