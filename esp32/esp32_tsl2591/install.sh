#!/usr/bin/env bash
# Compile and upload the esp32_tsl2591 sketch to an ESP32 dev board.
#
...
arduino-cli lib install "ArduinoJson" "Adafruit TSL2591 Library" "Adafruit Unified Sensor"
...
echo "Upload finished (esp32_tsl2591, $TRANSPORT)."
