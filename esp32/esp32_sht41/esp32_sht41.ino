/*
 * Sensor Tester Sensor Node — ESP32 + SHT41
 *
 * Implements the Sensor Tester Sensor Interface (see docs/sensor.md).
 * Reads a Sensirion SHT41 (temperature, humidity) via I2C.
 *
 ...
 *
 * Required Libraries:
 *   ArduinoJson, Wire, Adafruit SHT4x (+ Adafruit Unified Sensor),
...
void setup() {
  ...
  Wire.begin();
  if (!sht4.begin()) {
    Serial.println("Error: SHT41 not found!");
    while (1) delay(1000);
  }
