#!/usr/bin/env bash
# Compile and upload the esp32_sht41 sketch to an ESP32 dev board.
#
...
arduino-cli lib install "ArduinoJson" "Adafruit SHT4x Library"
...
echo "Upload finished (esp32_sht41, $TRANSPORT)."
