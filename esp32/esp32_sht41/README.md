# ESP32 SHT41 Sensor Node for Sensor Tester

This Arduino project implements the Sensor Tester
[Sensor Interface](../../../docs/sensor.md) on an ESP32 with a Sensirion
SHT41 I2C sensor (temperature, humidity).

> The SHT41 is a high-accuracy (±0.2 °C / ±1.8 %RH typical) temperature and
...
- **SHT41** module (temperature, humidity)
...
> The SHT41 uses fixed I2C address `0x44`.
...
3. **Libraries** (install via Library Manager):
   ...
   - `Adafruit SHT4x` (pulls in `Adafruit Unified Sensor`)
...
```json
{"sensor":"SHT41","host":"ESP32","temperature":22.6,"humidity":47.8}
```
