#!/usr/bin/env bash
# Compile and upload the esp32_mma7660 sketch to an ESP32 dev board.
#
...
arduino-cli lib install "ArduinoJson" "Accelerometer_MMA7660" "WebSockets"
...
echo "Upload finished (esp32_mma7660, $TRANSPORT)."
